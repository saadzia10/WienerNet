...
class PIAE_SDE_Reg_Sampling_Trainer:
    ...
    def train(self, model, loss_fn, train_data_loader, test_data_loader, noise_std, noise_mu, num_epochs,
        ...
        while epoch < num_epochs:
            ...
            for batch in train_data_loader:
                ...
                # Compute loss
                mse_loss_nee, mse_loss_E0, mse_loss_rb, mse_loss_temp, physics_loss, mse_loss_f = self.loss_function(
                    nee_pred, nee, dT_dt_pred, dtemp, k_pred, k, f_pred, f, residual, loss_fn)
            ...
            for batch in test_data_loader:
                ...
                nee_pred, dT_dt_pred, k_pred, f_pred, z, residual = model(x, b, k, T)
    ...
    def loss_function(self, nee_pred, nee_true, temp_pred, temp_true, E0_rb_pred, E0_rb_true,
                      f_pred, f_true, physics_residual, loss_fn):
        # Loss for NEE (u)
        ...
        return loss_nee, loss_E0, loss_rb, temp_loss, physics_loss, f_loss
...
class PIAE_SDE_Reg_Model(nn.Module):
    def __init__(self, input_dim, latent_dim, encoder_dims, decoder_dims, activation=nn.ReLU, device="mps"):
        super(PIAE_SDE_Reg_Model, self).__init__()
